...
const Hero = () => {
  const handleDownloadResume = () => {
    ...
    const fullResumePath = process.env.PUBLIC_URL + resumePath;
    window.open(fullResumePath, '_blank');
  };
  
  return (
    <div className="h-[88vh] bg-[url('/images/banner.jpg')] mt-[10vh] bg-cover bg-center">
      <Particle />
      <div className="w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          <h1 className="text-[35px] md:text-[50px] text-white font-bold ">
            HI, I'M <span className="text-yellow-400">SHUBHAM BHATT</span>
          </h1>
          <TextEffect />
